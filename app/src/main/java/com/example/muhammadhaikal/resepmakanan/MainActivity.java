package com.example.muhammadhaikal.resepmakanan;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputData("Lobster bumbu Padang","artikel_5.html");
        inputData("Sop Iga Sapi","artikel_6.html");
        inputData("Opor Ayam Kampung","artikel_7.html");
        inputData("Bebek Goreng Sambel Ijo","artikel_8.html");
        inputData("Soto Ayam Kampung","artikel_9.html");
        inputData("Bakso Ayam","artikel_10.html");
        inputData("Ikan Gurame Bakar","artikel_11.html");
        inputData("Pisang Bakar Coklat Keju","artikel_12.html");
        inputData("Kerak Telur","artikel_13.html");
        inputData("Martabak Telur","artikel_14.html");
